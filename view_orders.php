                            ...
                            ?>    
                                ...
                                <table class="table">
                                    ...
                                    <form action="code.php" method="POST">
                                        ...
                                        <select name="orders_status" id="" class="form-select">
                                            <option value="0" <?= $orders['orders_status'] == 0 ? "selected" : "" ?>>Under Process</option>
                                            <option value="1" <?= $orders['orders_status'] == 1 ? "selected" : "" ?>>Completed</option>
                                            <option value="2" <?= $orders['orders_status'] == 2 ? "selected" : "" ?>>Cancelled</option>
                                        </select> 
                                        <button type="submit" name="update_status_orders" class="btn btn-primary my-2">Update Status</button>
                                    </form>
